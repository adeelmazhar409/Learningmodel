...
function buildMockTasks(testDate: string, subject: string): RoadmapTask[] {
  ...
  const taskTemplates = [
    { description: `Review summary notes from last ${subject} lecture`,       method: "flashcards"  as const, duration_min: 15 },
    { description: `Complete 5 practice questions on ${subject}`,             method: "practice"    as const, duration_min: 20 },
    { description: `Record yourself explaining the main ${subject} concepts`, method: "teach_back"  as const, duration_min: 15 },
    { description: `Go through flashcards — aim for 100% accuracy`,          method: "flashcards"  as const, duration_min: 10 },
    { description: `Take the 5-question ${subject} quiz`,                    method: "practice"    as const, duration_min: 10 },
    { description: `Re-read your teach-back script and refine it`,           method: "teach_back"  as const, duration_min: 12 },
    { description: `Final review — redo any questions you got wrong`,        method: "practice"    as const, duration_min: 20 },
  ];
