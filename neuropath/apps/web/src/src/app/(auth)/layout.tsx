...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-svh flex flex-col items-center justify-center p-6 relative overflow-hidden bg-[#0c0c0e]">
      ...
      <div className="w-full max-w-[440px] bg-[#141418] border border-[rgba(255,255,255,0.07)] rounded-3xl px-9 py-10 relative z-10">
        ...
        <Link href="/" className="flex items-center gap-2.5 no-underline mb-8">
          <div className="w-[30px] h-[30px] bg-gradient-to-br from-[#e8603c] to-[#8c2410] rounded-full flex items-center justify-center shrink-0 shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_4px_12px_rgba(217,79,43,0.28)]">
          ...
          <span className="font-serif text-base font-semibold text-[#f0ede8] tracking-[0.01em]">NeuroPath</span>
        </Link>
        {children}
      </div>
    </div>
