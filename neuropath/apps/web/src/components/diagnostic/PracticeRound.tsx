...
export default function PracticeRound({ questions, onComplete }: Props) {
  ...
  function handleDone() {
    // submit unanswered as incorrect
      ...
      <div className="flex flex-col items-center gap-6 max-w-[540px] mx-auto w-full py-4 text-center">
        ...
        <div>
          ...
          <p className="text-[13.5px] text-soft font-light leading-relaxed">
            Now you&apos;ll apply what you learned. {questions.length}{" "}
            multiple-choice problems — pick the best answer, then tap{" "}
            <strong className="text-text font-semibold">Check</strong> to see if
    ...
    <div className="flex flex-col gap-5 max-w-[580px] mx-auto w-full">
      ...
      {!revealed ? (
        ...
        <div className="flex justify-end">
          ...
          >
            {index < questions.length - 1 ? "Next problem →" : "Finish round"}
          </button>
        </div>
      )}
    </div>
